# Fiche équipe — GET409-AMAZONE

## Identité de l'équipe

| Champ | Valeur |
|---|---|
| **Nom de l'équipe** | AMAZONE |
| **Cours** | GET 409 — Atelier IA |
| **Université** | Swiss UMEF University — Campus de Dakar |
| **Année** | 2025-2026 |
| **Secteur cible** | Santé et télémedecine — (Dakar) |
| **Dépôt GitHub** | [GET409-AMAZONE](https://github.com/charline-18/GET409-AMAZONE) |
| **Espace Dify** | GET409-AMAZONE |
...
| Adama | GUEYE | Responsable Impact | [@adamag244](https://github.com/adamag244) | gueyeadamapro@gmail.com |
